...
// NOP
Opcode Cpu::opcode_0x00_generator() {
...
// LD BC, d16
Opcode Cpu::opcode_0x01_generator() {
    std::vector<Step> steps;
...
// LD (BC), A
Opcode Cpu::opcode_0x02_generator() {
    std::vector<Step> steps;
...
// INC BC
Opcode Cpu::opcode_0x03_generator() {
    std::vector<Step> steps;
...
// LD B, d8
Opcode Cpu::opcode_0x06_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
...
// RLCA
Opcode Cpu::opcode_0x07_generator() {
    std::vector<Step> steps;
...
// LD (a16), SP
Opcode Cpu::opcode_0x08_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
    steps.push_back([this]() { z16 = (mmu->read(reg.pc++) << 8) | z8; });
...
// ADD HL, BC
Opcode Cpu::opcode_0x09_generator() {
    std::vector<Step> steps;
...
// LD A, (BC)
Opcode Cpu::opcode_0x0a_generator() {
    std::vector<Step> steps;
...
// DEC BC
Opcode Cpu::opcode_0x0b_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { reg.set_bc(reg.bc() - 1); });
...
// LD C, d8
Opcode Cpu::opcode_0x0e_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
...
// RRCA
Opcode Cpu::opcode_0x0f_generator() {
    std::vector<Step> steps;
...
// STOP 0
Opcode Cpu::opcode_0x10_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { ; });
...
// LD DE, d16
Opcode Cpu::opcode_0x11_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
    steps.push_back([this]() { z16 = (mmu->read(reg.pc++) << 8) | z8; });
...
// LD (DE), A
Opcode Cpu::opcode_0x12_generator() {
    std::vector<Step> steps;
...
// INC DE
Opcode Cpu::opcode_0x13_generator() {
    std::vector<Step> steps;
...
// LD D, d8
Opcode Cpu::opcode_0x16_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
...
// RLA
Opcode Cpu::opcode_0x17_generator() {
    std::vector<Step> steps;
...
// JR r8
Opcode Cpu::opcode_0x18_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
...
// ADD HL, DE
Opcode Cpu::opcode_0x19_generator() {
    std::vector<Step> steps;
...
// LD A, (DE)
Opcode Cpu::opcode_0x1a_generator() {
    std::vector<Step> steps;
...
// DEC DE
Opcode Cpu::opcode_0x1b_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { reg.set_de(reg.de() - 1); });
...
// LD E, d8
Opcode Cpu::opcode_0x1e_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
...
// RRA
Opcode Cpu::opcode_0x1f_generator() {
    std::vector<Step> steps;
...
// JR NZ, r8
Opcode Cpu::opcode_0x20_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++);
...
// LD HL, d16
Opcode Cpu::opcode_0x21_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
    steps.push_back([this]() { z16 = (mmu->read(reg.pc++) << 8) | z8; });
...
// LD (HL+), A
Opcode Cpu::opcode_0x22_generator() {
    std::vector<Step> steps;
...
// INC HL
Opcode Cpu::opcode_0x23_generator() {
    std::vector<Step> steps;
...
// LD H, d8
Opcode Cpu::opcode_0x26_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
...
// DAA
Opcode Cpu::opcode_0x27_generator() {
    std::vector<Step> steps;
...
// JR Z, r8
Opcode Cpu::opcode_0x28_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++);
        if (!reg.flag_z) early_exit = true; });
    steps.push_back([this]() { reg.pc = (uint16_t) (reg.pc + (int8_t) z8); });
...
// ADD HL, HL
Opcode Cpu::opcode_0x29_generator() {
    std::vector<Step> steps;
...
// LD A, (HL+)
Opcode Cpu::opcode_0x2a_generator() {
    std::vector<Step> steps;
...
// DEC HL
Opcode Cpu::opcode_0x2b_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { reg.set_hl(reg.hl() - 1); });
...
// LD L, d8
Opcode Cpu::opcode_0x2e_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
...
// CPL
Opcode Cpu::opcode_0x2f_generator() {
    std::vector<Step> steps;
...
// JR NC, r8
Opcode Cpu::opcode_0x30_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++);
...
// LD SP, d16
Opcode Cpu::opcode_0x31_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
    steps.push_back([this]() { z16 = (mmu->read(reg.pc++) << 8) | z8; });
...
// LD (HL-), A
Opcode Cpu::opcode_0x32_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { mmu->write(reg.hl(), reg.a);
        reg.set_hl(reg.hl() - 1); });
...
// INC SP
Opcode Cpu::opcode_0x33_generator() {
    std::vector<Step> steps;
...
// INC (HL)
Opcode Cpu::opcode_0x34_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// DEC (HL)
Opcode Cpu::opcode_0x35_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// LD (HL), d8
Opcode Cpu::opcode_0x36_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
    steps.push_back([this]() { mmu->write(reg.hl(), z8); });
...
// SCF
Opcode Cpu::opcode_0x37_generator() {
    std::vector<Step> steps;
...
// JR C, r8
Opcode Cpu::opcode_0x38_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++);
        if (!reg.flag_c) early_exit = true; });
    steps.push_back([this]() { reg.pc = (uint16_t) (reg.pc + (int8_t) z8); });
...
// ADD HL, SP
Opcode Cpu::opcode_0x39_generator() {
    std::vector<Step> steps;
...
// LD A, (HL-)
Opcode Cpu::opcode_0x3a_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl());
        reg.set_hl(reg.hl() - 1); });
    steps.push_back([this]() { reg.a = z8; });
...
// DEC SP
Opcode Cpu::opcode_0x3b_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { reg.sp--; });
...
// LD A, d8
Opcode Cpu::opcode_0x3e_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
    steps.push_back([this]() { reg.a = z8; });
...
// CCF
Opcode Cpu::opcode_0x3f_generator() {
    std::vector<Step> steps;
...
// LD B, B
Opcode Cpu::opcode_0x40_generator() {
    std::vector<Step> steps;
...
// LD B, C
Opcode Cpu::opcode_0x41_generator() {
    std::vector<Step> steps;
...
// LD B, D
Opcode Cpu::opcode_0x42_generator() {
    std::vector<Step> steps;
...
// LD B, E
Opcode Cpu::opcode_0x43_generator() {
    std::vector<Step> steps;
...
// LD B, H
Opcode Cpu::opcode_0x44_generator() {
    std::vector<Step> steps;
...
// LD B, L
Opcode Cpu::opcode_0x45_generator() {
    std::vector<Step> steps;
...
// LD B, (HL)
Opcode Cpu::opcode_0x46_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
    steps.push_back([this]() { reg.b = z8; });
...
// LD B, A
Opcode Cpu::opcode_0x47_generator() {
    std::vector<Step> steps;
...
// LD C, B
Opcode Cpu::opcode_0x48_generator() {
    std::vector<Step> steps;
...
// LD C, C
Opcode Cpu::opcode_0x49_generator() {
    std::vector<Step> steps;
...
// LD C, D
Opcode Cpu::opcode_0x4a_generator() {
    std::vector<Step> steps;
...
// LD C, E
Opcode Cpu::opcode_0x4b_generator() {
    std::vector<Step> steps;
...
// LD C, H
Opcode Cpu::opcode_0x4c_generator() {
    std::vector<Step> steps;
...
// LD C, L
Opcode Cpu::opcode_0x4d_generator() {
    std::vector<Step> steps;
...
// LD C, (HL)
Opcode Cpu::opcode_0x4e_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
    steps.push_back([this]() { reg.c = z8; });
...
// LD C, A
Opcode Cpu::opcode_0x4f_generator() {
    std::vector<Step> steps;
...
// LD D, B
Opcode Cpu::opcode_0x50_generator() {
    std::vector<Step> steps;
...
// LD D, C
Opcode Cpu::opcode_0x51_generator() {
    std::vector<Step> steps;
...
// LD D, D
Opcode Cpu::opcode_0x52_generator() {
    std::vector<Step> steps;
...
// LD D, E
Opcode Cpu::opcode_0x53_generator() {
    std::vector<Step> steps;
...
// LD D, H
Opcode Cpu::opcode_0x54_generator() {
    std::vector<Step> steps;
...
// LD D, L
Opcode Cpu::opcode_0x55_generator() {
    std::vector<Step> steps;
...
// LD D, (HL)
Opcode Cpu::opcode_0x56_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
    steps.push_back([this]() { reg.d = z8; });
...
// LD D, A
Opcode Cpu::opcode_0x57_generator() {
    std::vector<Step> steps;
...
// LD E, B
Opcode Cpu::opcode_0x58_generator() {
    std::vector<Step> steps;
...
// LD E, C
Opcode Cpu::opcode_0x59_generator() {
    std::vector<Step> steps;
...
// LD E, D
Opcode Cpu::opcode_0x5a_generator() {
    std::vector<Step> steps;
...
// LD E, E
Opcode Cpu::opcode_0x5b_generator() {
    std::vector<Step> steps;
...
// LD E, H
Opcode Cpu::opcode_0x5c_generator() {
    std::vector<Step> steps;
...
// LD E, L
Opcode Cpu::opcode_0x5d_generator() {
    std::vector<Step> steps;
...
// LD E, (HL)
Opcode Cpu::opcode_0x5e_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
    steps.push_back([this]() { reg.e = z8; });
...
// LD E, A
Opcode Cpu::opcode_0x5f_generator() {
    std::vector<Step> steps;
...
// LD H, B
Opcode Cpu::opcode_0x60_generator() {
    std::vector<Step> steps;
...
// LD H, C
Opcode Cpu::opcode_0x61_generator() {
    std::vector<Step> steps;
...
// LD H, D
Opcode Cpu::opcode_0x62_generator() {
    std::vector<Step> steps;
...
// LD H, E
Opcode Cpu::opcode_0x63_generator() {
    std::vector<Step> steps;
...
// LD H, H
Opcode Cpu::opcode_0x64_generator() {
    std::vector<Step> steps;
...
// LD H, L
Opcode Cpu::opcode_0x65_generator() {
    std::vector<Step> steps;
...
// LD H, (HL)
Opcode Cpu::opcode_0x66_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
    steps.push_back([this]() { reg.h = z8; });
...
// LD H, A
Opcode Cpu::opcode_0x67_generator() {
    std::vector<Step> steps;
...
// LD L, B
Opcode Cpu::opcode_0x68_generator() {
    std::vector<Step> steps;
...
// LD L, C
Opcode Cpu::opcode_0x69_generator() {
    std::vector<Step> steps;
...
// LD L, D
Opcode Cpu::opcode_0x6a_generator() {
    std::vector<Step> steps;
...
// LD L, E
Opcode Cpu::opcode_0x6b_generator() {
    std::vector<Step> steps;
...
// LD L, H
Opcode Cpu::opcode_0x6c_generator() {
    std::vector<Step> steps;
...
// LD L, L
Opcode Cpu::opcode_0x6d_generator() {
    std::vector<Step> steps;
...
// LD L, (HL)
Opcode Cpu::opcode_0x6e_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
    steps.push_back([this]() { reg.l = z8; });
...
// LD L, A
Opcode Cpu::opcode_0x6f_generator() {
    std::vector<Step> steps;
...
// LD (HL), B
Opcode Cpu::opcode_0x70_generator() {
    std::vector<Step> steps;
...
// LD (HL), C
Opcode Cpu::opcode_0x71_generator() {
    std::vector<Step> steps;
...
// LD (HL), D
Opcode Cpu::opcode_0x72_generator() {
    std::vector<Step> steps;
...
// LD (HL), E
Opcode Cpu::opcode_0x73_generator() {
    std::vector<Step> steps;
...
// LD (HL), H
Opcode Cpu::opcode_0x74_generator() {
    std::vector<Step> steps;
...
// LD (HL), L
Opcode Cpu::opcode_0x75_generator() {
    std::vector<Step> steps;
...
// HALT
Opcode Cpu::opcode_0x76_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { ; });
...
// LD (HL), A
Opcode Cpu::opcode_0x77_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { mmu->write(reg.hl(), reg.a); });
...
// LD A, B
Opcode Cpu::opcode_0x78_generator() {
    std::vector<Step> steps;
...
// LD A, C
Opcode Cpu::opcode_0x79_generator() {
    std::vector<Step> steps;
...
// LD A, D
Opcode Cpu::opcode_0x7a_generator() {
    std::vector<Step> steps;
...
// LD A, E
Opcode Cpu::opcode_0x7b_generator() {
    std::vector<Step> steps;
...
// LD A, H
Opcode Cpu::opcode_0x7c_generator() {
    std::vector<Step> steps;
...
// LD A, L
Opcode Cpu::opcode_0x7d_generator() {
    std::vector<Step> steps;
...
// LD A, (HL)
Opcode Cpu::opcode_0x7e_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
    steps.push_back([this]() { reg.a = z8; });
...
// LD A, A
Opcode Cpu::opcode_0x7f_generator() {
    std::vector<Step> steps;
...
// ADD A, B
Opcode Cpu::opcode_0x80_generator() {
    std::vector<Step> steps;
...
// ADD A, C
Opcode Cpu::opcode_0x81_generator() {
    std::vector<Step> steps;
...
// ADD A, D
Opcode Cpu::opcode_0x82_generator() {
    std::vector<Step> steps;
...
// ADD A, E
Opcode Cpu::opcode_0x83_generator() {
    std::vector<Step> steps;
...
// ADD A, H
Opcode Cpu::opcode_0x84_generator() {
    std::vector<Step> steps;
...
// ADD A, L
Opcode Cpu::opcode_0x85_generator() {
    std::vector<Step> steps;
...
// ADD A, (HL)
Opcode Cpu::opcode_0x86_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// ADD A, A
Opcode Cpu::opcode_0x87_generator() {
    std::vector<Step> steps;
...
// ADC A, B
Opcode Cpu::opcode_0x88_generator() {
    std::vector<Step> steps;
...
// ADC A, C
Opcode Cpu::opcode_0x89_generator() {
    std::vector<Step> steps;
...
// ADC A, D
Opcode Cpu::opcode_0x8a_generator() {
    std::vector<Step> steps;
...
// ADC A, E
Opcode Cpu::opcode_0x8b_generator() {
    std::vector<Step> steps;
...
// ADC A, H
Opcode Cpu::opcode_0x8c_generator() {
    std::vector<Step> steps;
...
// ADC A, L
Opcode Cpu::opcode_0x8d_generator() {
    std::vector<Step> steps;
...
// ADC A, (HL)
Opcode Cpu::opcode_0x8e_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// ADC A, A
Opcode Cpu::opcode_0x8f_generator() {
    std::vector<Step> steps;
...
// SUB B
Opcode Cpu::opcode_0x90_generator() {
    std::vector<Step> steps;
...
// SUB C
Opcode Cpu::opcode_0x91_generator() {
    std::vector<Step> steps;
...
// SUB D
Opcode Cpu::opcode_0x92_generator() {
    std::vector<Step> steps;
...
// SUB E
Opcode Cpu::opcode_0x93_generator() {
    std::vector<Step> steps;
...
// SUB H
Opcode Cpu::opcode_0x94_generator() {
    std::vector<Step> steps;
...
// SUB L
Opcode Cpu::opcode_0x95_generator() {
    std::vector<Step> steps;
...
// SUB (HL)
Opcode Cpu::opcode_0x96_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// SUB A
Opcode Cpu::opcode_0x97_generator() {
    std::vector<Step> steps;
...
// SBC A, B
Opcode Cpu::opcode_0x98_generator() {
    std::vector<Step> steps;
...
// SBC A, C
Opcode Cpu::opcode_0x99_generator() {
    std::vector<Step> steps;
...
// SBC A, D
Opcode Cpu::opcode_0x9a_generator() {
    std::vector<Step> steps;
...
// SBC A, E
Opcode Cpu::opcode_0x9b_generator() {
    std::vector<Step> steps;
...
// SBC A, H
Opcode Cpu::opcode_0x9c_generator() {
    std::vector<Step> steps;
...
// SBC A, L
Opcode Cpu::opcode_0x9d_generator() {
    std::vector<Step> steps;
...
// SBC A, (HL)
Opcode Cpu::opcode_0x9e_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// SBC A, A
Opcode Cpu::opcode_0x9f_generator() {
    std::vector<Step> steps;
...
// AND B
Opcode Cpu::opcode_0xa0_generator() {
    std::vector<Step> steps;
...
// AND C
Opcode Cpu::opcode_0xa1_generator() {
    std::vector<Step> steps;
...
// AND D
Opcode Cpu::opcode_0xa2_generator() {
    std::vector<Step> steps;
...
// AND E
Opcode Cpu::opcode_0xa3_generator() {
    std::vector<Step> steps;
...
// AND H
Opcode Cpu::opcode_0xa4_generator() {
    std::vector<Step> steps;
...
// AND L
Opcode Cpu::opcode_0xa5_generator() {
    std::vector<Step> steps;
...
// AND (HL)
Opcode Cpu::opcode_0xa6_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// AND A
Opcode Cpu::opcode_0xa7_generator() {
    std::vector<Step> steps;
...
// XOR B
Opcode Cpu::opcode_0xa8_generator() {
    std::vector<Step> steps;
...
// XOR C
Opcode Cpu::opcode_0xa9_generator() {
    std::vector<Step> steps;
...
// XOR D
Opcode Cpu::opcode_0xaa_generator() {
    std::vector<Step> steps;
...
// XOR E
Opcode Cpu::opcode_0xab_generator() {
    std::vector<Step> steps;
...
// XOR H
Opcode Cpu::opcode_0xac_generator() {
    std::vector<Step> steps;
...
// XOR L
Opcode Cpu::opcode_0xad_generator() {
    std::vector<Step> steps;
...
// XOR (HL)
Opcode Cpu::opcode_0xae_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// XOR A
Opcode Cpu::opcode_0xaf_generator() {
    std::vector<Step> steps;
...
// OR B
Opcode Cpu::opcode_0xb0_generator() {
    std::vector<Step> steps;
...
// OR C
Opcode Cpu::opcode_0xb1_generator() {
    std::vector<Step> steps;
...
// OR D
Opcode Cpu::opcode_0xb2_generator() {
    std::vector<Step> steps;
...
// OR E
Opcode Cpu::opcode_0xb3_generator() {
    std::vector<Step> steps;
...
// OR H
Opcode Cpu::opcode_0xb4_generator() {
    std::vector<Step> steps;
...
// OR L
Opcode Cpu::opcode_0xb5_generator() {
    std::vector<Step> steps;
...
// OR (HL)
Opcode Cpu::opcode_0xb6_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// OR A
Opcode Cpu::opcode_0xb7_generator() {
    std::vector<Step> steps;
...
// CP B
Opcode Cpu::opcode_0xb8_generator() {
    std::vector<Step> steps;
...
// CP C
Opcode Cpu::opcode_0xb9_generator() {
    std::vector<Step> steps;
...
// CP D
Opcode Cpu::opcode_0xba_generator() {
    std::vector<Step> steps;
...
// CP E
Opcode Cpu::opcode_0xbb_generator() {
    std::vector<Step> steps;
...
// CP H
Opcode Cpu::opcode_0xbc_generator() {
    std::vector<Step> steps;
...
// CP L
Opcode Cpu::opcode_0xbd_generator() {
    std::vector<Step> steps;
...
// CP (HL)
Opcode Cpu::opcode_0xbe_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// CP A
Opcode Cpu::opcode_0xbf_generator() {
    std::vector<Step> steps;
...
// RET NZ
Opcode Cpu::opcode_0xc0_generator() {
    std::vector<Step> steps;
...
// POP BC
Opcode Cpu::opcode_0xc1_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.sp++); });
    steps.push_back([this]() { z16 = (mmu->read(reg.sp++) << 8) | z8; });
    steps.push_back([this]() { reg.set_bc(z16); });
...
// JP NZ, a16
Opcode Cpu::opcode_0xc2_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
    steps.push_back([this]() { z16 = (mmu->read(reg.pc++) << 8) | z8;
        if (reg.flag_z) early_exit = true; });
...
// JP a16
Opcode Cpu::opcode_0xc3_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
    steps.push_back([this]() { z16 = (mmu->read(reg.pc++) << 8) | z8; });
    steps.push_back([this]() { reg.pc = z16; });
...
// CALL NZ, a16
Opcode Cpu::opcode_0xc4_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
    steps.push_back([this]() { z16 = (mmu->read(reg.pc++) << 8) | z8;
        if (reg.flag_z) early_exit = true; });
...
// PUSH BC
Opcode Cpu::opcode_0xc5_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { reg.sp--; });
...
// ADD A, d8
Opcode Cpu::opcode_0xc6_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
    steps.push_back([this]() { add(z8); });
...
// RST 00H
Opcode Cpu::opcode_0xc7_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { reg.sp--; });
    steps.push_back([this]() { mmu->write(reg.sp--, reg.pc >> 8); });
    steps.push_back([this]() { mmu->write(reg.sp, reg.pc & 0xFF);
...
// RET Z
Opcode Cpu::opcode_0xc8_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { if (!reg.flag_z) early_exit = true; });
    steps.push_back([this]() { z8 = mmu->read(reg.sp++); });
    steps.push_back([this]() { z16 = (mmu->read(reg.sp++) << 8) | z8; });
...
// RET
Opcode Cpu::opcode_0xc9_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.sp++); });
    steps.push_back([this]() { z16 = (mmu->read(reg.sp++) << 8) | z8; });
    steps.push_back([this]() { reg.pc = z16; });
...
// JP Z, a16
Opcode Cpu::opcode_0xca_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
    steps.push_back([this]() { z16 = (mmu->read(reg.pc++) << 8) | z8;
        if (!reg.flag_z) early_exit = true; });
...
// PREFIX CB
Opcode Cpu::opcode_0xcb_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { ; });
...
// CALL Z, a16
Opcode Cpu::opcode_0xcc_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
    steps.push_back([this]() { z16 = (mmu->read(reg.pc++) << 8) | z8;
        if (!reg.flag_z) early_exit = true; });
...
// CALL a16
Opcode Cpu::opcode_0xcd_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
    steps.push_back([this]() { z16 = (mmu->read(reg.pc++) << 8) | z8; });
    steps.push_back([this]() { reg.sp--; });
...
// ADC A, d8
Opcode Cpu::opcode_0xce_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
    steps.push_back([this]() { add_with_carry(z8); });
...
// RST 08H
Opcode Cpu::opcode_0xcf_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { reg.sp--; });
    steps.push_back([this]() { mmu->write(reg.sp--, reg.pc >> 8); });
    steps.push_back([this]() { mmu->write(reg.sp, reg.pc & 0xFF);
...
// RET NC
Opcode Cpu::opcode_0xd0_generator() {
    std::vector<Step> steps;
...
// POP DE
Opcode Cpu::opcode_0xd1_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.sp++); });
    steps.push_back([this]() { z16 = (mmu->read(reg.sp++) << 8) | z8; });
    steps.push_back([this]() { reg.set_de(z16); });
...
// JP NC, a16
Opcode Cpu::opcode_0xd2_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
    steps.push_back([this]() { z16 = (mmu->read(reg.pc++) << 8) | z8;
        if (reg.flag_c) early_exit = true; });
...
// CALL NC, a16
Opcode Cpu::opcode_0xd4_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
    steps.push_back([this]() { z16 = (mmu->read(reg.pc++) << 8) | z8;
        if (reg.flag_c) early_exit = true; });
...
// PUSH DE
Opcode Cpu::opcode_0xd5_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { reg.sp--; });
...
// SUB d8
Opcode Cpu::opcode_0xd6_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
    steps.push_back([this]() { subtract(z8); });
...
// RST 10H
Opcode Cpu::opcode_0xd7_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { reg.sp--; });
    steps.push_back([this]() { mmu->write(reg.sp--, reg.pc >> 8); });
    steps.push_back([this]() { mmu->write(reg.sp, reg.pc & 0xFF);
...
// RET C
Opcode Cpu::opcode_0xd8_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { if (!reg.flag_c) early_exit = true; });
    steps.push_back([this]() { z8 = mmu->read(reg.sp++); });
    steps.push_back([this]() { z16 = (mmu->read(reg.sp++) << 8) | z8; });
...
// RETI
Opcode Cpu::opcode_0xd9_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.sp++); });
    steps.push_back([this]() { z16 = (mmu->read(reg.sp++) << 8) | z8; });
    steps.push_back([this]() { reg.pc = z16;
...
// JP C, a16
Opcode Cpu::opcode_0xda_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
    steps.push_back([this]() { z16 = (mmu->read(reg.pc++) << 8) | z8;
        if (!reg.flag_c) early_exit = true; });
...
// CALL C, a16
Opcode Cpu::opcode_0xdc_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
    steps.push_back([this]() { z16 = (mmu->read(reg.pc++) << 8) | z8;
        if (!reg.flag_c) early_exit = true; });
...
// SBC A, d8
Opcode Cpu::opcode_0xde_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
    steps.push_back([this]() { subtract_with_carry(z8); });
...
// RST 18H
Opcode Cpu::opcode_0xdf_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { reg.sp--; });
    steps.push_back([this]() { mmu->write(reg.sp--, reg.pc >> 8); });
    steps.push_back([this]() { mmu->write(reg.sp, reg.pc & 0xFF);
...
// LDH (a8), A
Opcode Cpu::opcode_0xe0_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
...
// POP HL
Opcode Cpu::opcode_0xe1_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.sp++); });
    steps.push_back([this]() { z16 = (mmu->read(reg.sp++) << 8) | z8; });
    steps.push_back([this]() { reg.set_hl(z16); });
...
// LDH (C), A
Opcode Cpu::opcode_0xe2_generator() {
    std::vector<Step> steps;
...
// PUSH HL
Opcode Cpu::opcode_0xe5_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { reg.sp--; });
...
// AND d8
Opcode Cpu::opcode_0xe6_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
    steps.push_back([this]() { and_(z8); });
...
// RST 20H
Opcode Cpu::opcode_0xe7_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { reg.sp--; });
    steps.push_back([this]() { mmu->write(reg.sp--, reg.pc >> 8); });
    steps.push_back([this]() { mmu->write(reg.sp, reg.pc & 0xFF);
...
// JP HL
Opcode Cpu::opcode_0xe9_generator() {
    std::vector<Step> steps;
...
// LD (a16), A
Opcode Cpu::opcode_0xea_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
    steps.push_back([this]() { z16 = (mmu->read(reg.pc++) << 8) | z8; });
...
// XOR d8
Opcode Cpu::opcode_0xee_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
    steps.push_back([this]() { xor_(z8); });
...
// RST 28H
Opcode Cpu::opcode_0xef_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { reg.sp--; });
    steps.push_back([this]() { mmu->write(reg.sp--, reg.pc >> 8); });
    steps.push_back([this]() { mmu->write(reg.sp, reg.pc & 0xFF);
...
// LDH A, (a8)
Opcode Cpu::opcode_0xf0_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
...
// POP AF
Opcode Cpu::opcode_0xf1_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.sp++); });
    steps.push_back([this]() { z16 = (mmu->read(reg.sp++) << 8) | z8; });
...
// LDH A, (C)
Opcode Cpu::opcode_0xf2_generator() {
    std::vector<Step> steps;
...
// PUSH AF
Opcode Cpu::opcode_0xf5_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { reg.sp--; });
...
// OR d8
Opcode Cpu::opcode_0xf6_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
    steps.push_back([this]() { or_(z8); });
...
// RST 30H
Opcode Cpu::opcode_0xf7_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { reg.sp--; });
    steps.push_back([this]() { mmu->write(reg.sp--, reg.pc >> 8); });
    steps.push_back([this]() { mmu->write(reg.sp, reg.pc & 0xFF);
...
// LD SP, HL
Opcode Cpu::opcode_0xf9_generator() {
    std::vector<Step> steps;
...
// LD A, (a16)
Opcode Cpu::opcode_0xfa_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
    steps.push_back([this]() { z16 = (mmu->read(reg.pc++) << 8) | z8; });
...
// EI
Opcode Cpu::opcode_0xfb_generator() {
    std::vector<Step> steps;
...
// CP d8
Opcode Cpu::opcode_0xfe_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.pc++); });
    steps.push_back([this]() { compare(z8); });
...
// RST 38H
Opcode Cpu::opcode_0xff_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { reg.sp--; });
    steps.push_back([this]() { mmu->write(reg.sp--, reg.pc >> 8); });
    steps.push_back([this]() { mmu->write(reg.sp, reg.pc & 0xFF);
...
// RLC B
Opcode Cpu::opcode_cb_0x00_generator() {
    std::vector<Step> steps;
...
// RLC C
Opcode Cpu::opcode_cb_0x01_generator() {
    std::vector<Step> steps;
...
// RLC D
Opcode Cpu::opcode_cb_0x02_generator() {
    std::vector<Step> steps;
...
// RLC E
Opcode Cpu::opcode_cb_0x03_generator() {
    std::vector<Step> steps;
...
// RLC H
Opcode Cpu::opcode_cb_0x04_generator() {
    std::vector<Step> steps;
...
// RLC L
Opcode Cpu::opcode_cb_0x05_generator() {
    std::vector<Step> steps;
...
// RLC (HL)
Opcode Cpu::opcode_cb_0x06_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// RLC A
Opcode Cpu::opcode_cb_0x07_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { reg.a = rotate_left_circular(reg.a); });
...
// RRC B
Opcode Cpu::opcode_cb_0x08_generator() {
    std::vector<Step> steps;
...
// RRC C
Opcode Cpu::opcode_cb_0x09_generator() {
    std::vector<Step> steps;
...
// RRC D
Opcode Cpu::opcode_cb_0x0a_generator() {
    std::vector<Step> steps;
...
// RRC E
Opcode Cpu::opcode_cb_0x0b_generator() {
    std::vector<Step> steps;
...
// RRC H
Opcode Cpu::opcode_cb_0x0c_generator() {
    std::vector<Step> steps;
...
// RRC L
Opcode Cpu::opcode_cb_0x0d_generator() {
    std::vector<Step> steps;
...
// RRC (HL)
Opcode Cpu::opcode_cb_0x0e_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// RRC A
Opcode Cpu::opcode_cb_0x0f_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { reg.a = rotate_right_circular(reg.a); });
...
// RL B
Opcode Cpu::opcode_cb_0x10_generator() {
    std::vector<Step> steps;
...
// RL C
Opcode Cpu::opcode_cb_0x11_generator() {
    std::vector<Step> steps;
...
// RL D
Opcode Cpu::opcode_cb_0x12_generator() {
    std::vector<Step> steps;
...
// RL E
Opcode Cpu::opcode_cb_0x13_generator() {
    std::vector<Step> steps;
...
// RL H
Opcode Cpu::opcode_cb_0x14_generator() {
    std::vector<Step> steps;
...
// RL L
Opcode Cpu::opcode_cb_0x15_generator() {
    std::vector<Step> steps;
...
// RL (HL)
Opcode Cpu::opcode_cb_0x16_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// RL A
Opcode Cpu::opcode_cb_0x17_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { reg.a = rotate_left(reg.a); });
...
// RR B
Opcode Cpu::opcode_cb_0x18_generator() {
    std::vector<Step> steps;
...
// RR C
Opcode Cpu::opcode_cb_0x19_generator() {
    std::vector<Step> steps;
...
// RR D
Opcode Cpu::opcode_cb_0x1a_generator() {
    std::vector<Step> steps;
...
// RR E
Opcode Cpu::opcode_cb_0x1b_generator() {
    std::vector<Step> steps;
...
// RR H
Opcode Cpu::opcode_cb_0x1c_generator() {
    std::vector<Step> steps;
...
// RR L
Opcode Cpu::opcode_cb_0x1d_generator() {
    std::vector<Step> steps;
...
// RR (HL)
Opcode Cpu::opcode_cb_0x1e_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// RR A
Opcode Cpu::opcode_cb_0x1f_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { reg.a = rotate_right(reg.a); });
...
// SLA B
Opcode Cpu::opcode_cb_0x20_generator() {
    std::vector<Step> steps;
...
// SLA C
Opcode Cpu::opcode_cb_0x21_generator() {
    std::vector<Step> steps;
...
// SLA D
Opcode Cpu::opcode_cb_0x22_generator() {
    std::vector<Step> steps;
...
// SLA E
Opcode Cpu::opcode_cb_0x23_generator() {
    std::vector<Step> steps;
...
// SLA H
Opcode Cpu::opcode_cb_0x24_generator() {
    std::vector<Step> steps;
...
// SLA L
Opcode Cpu::opcode_cb_0x25_generator() {
    std::vector<Step> steps;
...
// SLA (HL)
Opcode Cpu::opcode_cb_0x26_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// SLA A
Opcode Cpu::opcode_cb_0x27_generator() {
    std::vector<Step> steps;
...
// SRA B
Opcode Cpu::opcode_cb_0x28_generator() {
    std::vector<Step> steps;
...
// SRA C
Opcode Cpu::opcode_cb_0x29_generator() {
    std::vector<Step> steps;
...
// SRA D
Opcode Cpu::opcode_cb_0x2a_generator() {
    std::vector<Step> steps;
...
// SRA E
Opcode Cpu::opcode_cb_0x2b_generator() {
    std::vector<Step> steps;
...
// SRA H
Opcode Cpu::opcode_cb_0x2c_generator() {
    std::vector<Step> steps;
...
// SRA L
Opcode Cpu::opcode_cb_0x2d_generator() {
    std::vector<Step> steps;
...
// SRA (HL)
Opcode Cpu::opcode_cb_0x2e_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// SRA A
Opcode Cpu::opcode_cb_0x2f_generator() {
    std::vector<Step> steps;
...
// SWAP B
Opcode Cpu::opcode_cb_0x30_generator() {
    std::vector<Step> steps;
...
// SWAP C
Opcode Cpu::opcode_cb_0x31_generator() {
    std::vector<Step> steps;
...
// SWAP D
Opcode Cpu::opcode_cb_0x32_generator() {
    std::vector<Step> steps;
...
// SWAP E
Opcode Cpu::opcode_cb_0x33_generator() {
    std::vector<Step> steps;
...
// SWAP H
Opcode Cpu::opcode_cb_0x34_generator() {
    std::vector<Step> steps;
...
// SWAP L
Opcode Cpu::opcode_cb_0x35_generator() {
    std::vector<Step> steps;
...
// SWAP (HL)
Opcode Cpu::opcode_cb_0x36_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// SWAP A
Opcode Cpu::opcode_cb_0x37_generator() {
    std::vector<Step> steps;
...
// SRL B
Opcode Cpu::opcode_cb_0x38_generator() {
    std::vector<Step> steps;
...
// SRL C
Opcode Cpu::opcode_cb_0x39_generator() {
    std::vector<Step> steps;
...
// SRL D
Opcode Cpu::opcode_cb_0x3a_generator() {
    std::vector<Step> steps;
...
// SRL E
Opcode Cpu::opcode_cb_0x3b_generator() {
    std::vector<Step> steps;
...
// SRL H
Opcode Cpu::opcode_cb_0x3c_generator() {
    std::vector<Step> steps;
...
// SRL L
Opcode Cpu::opcode_cb_0x3d_generator() {
    std::vector<Step> steps;
...
// SRL (HL)
Opcode Cpu::opcode_cb_0x3e_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// SRL A
Opcode Cpu::opcode_cb_0x3f_generator() {
    std::vector<Step> steps;
...
// BIT 0, B
Opcode Cpu::opcode_cb_0x40_generator() {
    std::vector<Step> steps;
...
// BIT 0, C
Opcode Cpu::opcode_cb_0x41_generator() {
    std::vector<Step> steps;
...
// BIT 0, D
Opcode Cpu::opcode_cb_0x42_generator() {
    std::vector<Step> steps;
...
// BIT 0, E
Opcode Cpu::opcode_cb_0x43_generator() {
    std::vector<Step> steps;
...
// BIT 0, H
Opcode Cpu::opcode_cb_0x44_generator() {
    std::vector<Step> steps;
...
// BIT 0, L
Opcode Cpu::opcode_cb_0x45_generator() {
    std::vector<Step> steps;
...
// BIT 0, (HL)
Opcode Cpu::opcode_cb_0x46_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// BIT 0, A
Opcode Cpu::opcode_cb_0x47_generator() {
    std::vector<Step> steps;
...
// BIT 1, B
Opcode Cpu::opcode_cb_0x48_generator() {
    std::vector<Step> steps;
...
// BIT 1, C
Opcode Cpu::opcode_cb_0x49_generator() {
    std::vector<Step> steps;
...
// BIT 1, D
Opcode Cpu::opcode_cb_0x4a_generator() {
    std::vector<Step> steps;
...
// BIT 1, E
Opcode Cpu::opcode_cb_0x4b_generator() {
    std::vector<Step> steps;
...
// BIT 1, H
Opcode Cpu::opcode_cb_0x4c_generator() {
    std::vector<Step> steps;
...
// BIT 1, L
Opcode Cpu::opcode_cb_0x4d_generator() {
    std::vector<Step> steps;
...
// BIT 1, (HL)
Opcode Cpu::opcode_cb_0x4e_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// BIT 1, A
Opcode Cpu::opcode_cb_0x4f_generator() {
    std::vector<Step> steps;
...
// BIT 2, B
Opcode Cpu::opcode_cb_0x50_generator() {
    std::vector<Step> steps;
...
// BIT 2, C
Opcode Cpu::opcode_cb_0x51_generator() {
    std::vector<Step> steps;
...
// BIT 2, D
Opcode Cpu::opcode_cb_0x52_generator() {
    std::vector<Step> steps;
...
// BIT 2, E
Opcode Cpu::opcode_cb_0x53_generator() {
    std::vector<Step> steps;
...
// BIT 2, H
Opcode Cpu::opcode_cb_0x54_generator() {
    std::vector<Step> steps;
...
// BIT 2, L
Opcode Cpu::opcode_cb_0x55_generator() {
    std::vector<Step> steps;
...
// BIT 2, (HL)
Opcode Cpu::opcode_cb_0x56_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// BIT 2, A
Opcode Cpu::opcode_cb_0x57_generator() {
    std::vector<Step> steps;
...
// BIT 3, B
Opcode Cpu::opcode_cb_0x58_generator() {
    std::vector<Step> steps;
...
// BIT 3, C
Opcode Cpu::opcode_cb_0x59_generator() {
    std::vector<Step> steps;
...
// BIT 3, D
Opcode Cpu::opcode_cb_0x5a_generator() {
    std::vector<Step> steps;
...
// BIT 3, E
Opcode Cpu::opcode_cb_0x5b_generator() {
    std::vector<Step> steps;
...
// BIT 3, H
Opcode Cpu::opcode_cb_0x5c_generator() {
    std::vector<Step> steps;
...
// BIT 3, L
Opcode Cpu::opcode_cb_0x5d_generator() {
    std::vector<Step> steps;
...
// BIT 3, (HL)
Opcode Cpu::opcode_cb_0x5e_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// BIT 3, A
Opcode Cpu::opcode_cb_0x5f_generator() {
    std::vector<Step> steps;
...
// BIT 4, B
Opcode Cpu::opcode_cb_0x60_generator() {
    std::vector<Step> steps;
...
// BIT 4, C
Opcode Cpu::opcode_cb_0x61_generator() {
    std::vector<Step> steps;
...
// BIT 4, D
Opcode Cpu::opcode_cb_0x62_generator() {
    std::vector<Step> steps;
...
// BIT 4, E
Opcode Cpu::opcode_cb_0x63_generator() {
    std::vector<Step> steps;
...
// BIT 4, H
Opcode Cpu::opcode_cb_0x64_generator() {
    std::vector<Step> steps;
...
// BIT 4, L
Opcode Cpu::opcode_cb_0x65_generator() {
    std::vector<Step> steps;
...
// BIT 4, (HL)
Opcode Cpu::opcode_cb_0x66_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// BIT 4, A
Opcode Cpu::opcode_cb_0x67_generator() {
    std::vector<Step> steps;
...
// BIT 5, B
Opcode Cpu::opcode_cb_0x68_generator() {
    std::vector<Step> steps;
...
// BIT 5, C
Opcode Cpu::opcode_cb_0x69_generator() {
    std::vector<Step> steps;
...
// BIT 5, D
Opcode Cpu::opcode_cb_0x6a_generator() {
    std::vector<Step> steps;
...
// BIT 5, E
Opcode Cpu::opcode_cb_0x6b_generator() {
    std::vector<Step> steps;
...
// BIT 5, H
Opcode Cpu::opcode_cb_0x6c_generator() {
    std::vector<Step> steps;
...
// BIT 5, L
Opcode Cpu::opcode_cb_0x6d_generator() {
    std::vector<Step> steps;
...
// BIT 5, (HL)
Opcode Cpu::opcode_cb_0x6e_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// BIT 5, A
Opcode Cpu::opcode_cb_0x6f_generator() {
    std::vector<Step> steps;
...
// BIT 6, B
Opcode Cpu::opcode_cb_0x70_generator() {
    std::vector<Step> steps;
...
// BIT 6, C
Opcode Cpu::opcode_cb_0x71_generator() {
    std::vector<Step> steps;
...
// BIT 6, D
Opcode Cpu::opcode_cb_0x72_generator() {
    std::vector<Step> steps;
...
// BIT 6, E
Opcode Cpu::opcode_cb_0x73_generator() {
    std::vector<Step> steps;
...
// BIT 6, H
Opcode Cpu::opcode_cb_0x74_generator() {
    std::vector<Step> steps;
...
// BIT 6, L
Opcode Cpu::opcode_cb_0x75_generator() {
    std::vector<Step> steps;
...
// BIT 6, (HL)
Opcode Cpu::opcode_cb_0x76_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// BIT 6, A
Opcode Cpu::opcode_cb_0x77_generator() {
    std::vector<Step> steps;
...
// BIT 7, B
Opcode Cpu::opcode_cb_0x78_generator() {
    std::vector<Step> steps;
...
// BIT 7, C
Opcode Cpu::opcode_cb_0x79_generator() {
    std::vector<Step> steps;
...
// BIT 7, D
Opcode Cpu::opcode_cb_0x7a_generator() {
    std::vector<Step> steps;
...
// BIT 7, E
Opcode Cpu::opcode_cb_0x7b_generator() {
    std::vector<Step> steps;
...
// BIT 7, H
Opcode Cpu::opcode_cb_0x7c_generator() {
    std::vector<Step> steps;
...
// BIT 7, L
Opcode Cpu::opcode_cb_0x7d_generator() {
    std::vector<Step> steps;
...
// BIT 7, (HL)
Opcode Cpu::opcode_cb_0x7e_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// BIT 7, A
Opcode Cpu::opcode_cb_0x7f_generator() {
    std::vector<Step> steps;
...
// RES 0, B
Opcode Cpu::opcode_cb_0x80_generator() {
    std::vector<Step> steps;
...
// RES 0, C
Opcode Cpu::opcode_cb_0x81_generator() {
    std::vector<Step> steps;
...
// RES 0, D
Opcode Cpu::opcode_cb_0x82_generator() {
    std::vector<Step> steps;
...
// RES 0, E
Opcode Cpu::opcode_cb_0x83_generator() {
    std::vector<Step> steps;
...
// RES 0, H
Opcode Cpu::opcode_cb_0x84_generator() {
    std::vector<Step> steps;
...
// RES 0, L
Opcode Cpu::opcode_cb_0x85_generator() {
    std::vector<Step> steps;
...
// RES 0, (HL)
Opcode Cpu::opcode_cb_0x86_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// RES 0, A
Opcode Cpu::opcode_cb_0x87_generator() {
    std::vector<Step> steps;
...
// RES 1, B
Opcode Cpu::opcode_cb_0x88_generator() {
    std::vector<Step> steps;
...
// RES 1, C
Opcode Cpu::opcode_cb_0x89_generator() {
    std::vector<Step> steps;
...
// RES 1, D
Opcode Cpu::opcode_cb_0x8a_generator() {
    std::vector<Step> steps;
...
// RES 1, E
Opcode Cpu::opcode_cb_0x8b_generator() {
    std::vector<Step> steps;
...
// RES 1, H
Opcode Cpu::opcode_cb_0x8c_generator() {
    std::vector<Step> steps;
...
// RES 1, L
Opcode Cpu::opcode_cb_0x8d_generator() {
    std::vector<Step> steps;
...
// RES 1, (HL)
Opcode Cpu::opcode_cb_0x8e_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// RES 1, A
Opcode Cpu::opcode_cb_0x8f_generator() {
    std::vector<Step> steps;
...
// RES 2, B
Opcode Cpu::opcode_cb_0x90_generator() {
    std::vector<Step> steps;
...
// RES 2, C
Opcode Cpu::opcode_cb_0x91_generator() {
    std::vector<Step> steps;
...
// RES 2, D
Opcode Cpu::opcode_cb_0x92_generator() {
    std::vector<Step> steps;
...
// RES 2, E
Opcode Cpu::opcode_cb_0x93_generator() {
    std::vector<Step> steps;
...
// RES 2, H
Opcode Cpu::opcode_cb_0x94_generator() {
    std::vector<Step> steps;
...
// RES 2, L
Opcode Cpu::opcode_cb_0x95_generator() {
    std::vector<Step> steps;
...
// RES 2, (HL)
Opcode Cpu::opcode_cb_0x96_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// RES 2, A
Opcode Cpu::opcode_cb_0x97_generator() {
    std::vector<Step> steps;
...
// RES 3, B
Opcode Cpu::opcode_cb_0x98_generator() {
    std::vector<Step> steps;
...
// RES 3, C
Opcode Cpu::opcode_cb_0x99_generator() {
    std::vector<Step> steps;
...
// RES 3, D
Opcode Cpu::opcode_cb_0x9a_generator() {
    std::vector<Step> steps;
...
// RES 3, E
Opcode Cpu::opcode_cb_0x9b_generator() {
    std::vector<Step> steps;
...
// RES 3, H
Opcode Cpu::opcode_cb_0x9c_generator() {
    std::vector<Step> steps;
...
// RES 3, L
Opcode Cpu::opcode_cb_0x9d_generator() {
    std::vector<Step> steps;
...
// RES 3, (HL)
Opcode Cpu::opcode_cb_0x9e_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// RES 3, A
Opcode Cpu::opcode_cb_0x9f_generator() {
    std::vector<Step> steps;
...
// RES 4, B
Opcode Cpu::opcode_cb_0xa0_generator() {
    std::vector<Step> steps;
...
// RES 4, C
Opcode Cpu::opcode_cb_0xa1_generator() {
    std::vector<Step> steps;
...
// RES 4, D
Opcode Cpu::opcode_cb_0xa2_generator() {
    std::vector<Step> steps;
...
// RES 4, E
Opcode Cpu::opcode_cb_0xa3_generator() {
    std::vector<Step> steps;
...
// RES 4, H
Opcode Cpu::opcode_cb_0xa4_generator() {
    std::vector<Step> steps;
...
// RES 4, L
Opcode Cpu::opcode_cb_0xa5_generator() {
    std::vector<Step> steps;
...
// RES 4, (HL)
Opcode Cpu::opcode_cb_0xa6_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// RES 4, A
Opcode Cpu::opcode_cb_0xa7_generator() {
    std::vector<Step> steps;
...
// RES 5, B
Opcode Cpu::opcode_cb_0xa8_generator() {
    std::vector<Step> steps;
...
// RES 5, C
Opcode Cpu::opcode_cb_0xa9_generator() {
    std::vector<Step> steps;
...
// RES 5, D
Opcode Cpu::opcode_cb_0xaa_generator() {
    std::vector<Step> steps;
...
// RES 5, E
Opcode Cpu::opcode_cb_0xab_generator() {
    std::vector<Step> steps;
...
// RES 5, H
Opcode Cpu::opcode_cb_0xac_generator() {
    std::vector<Step> steps;
...
// RES 5, L
Opcode Cpu::opcode_cb_0xad_generator() {
    std::vector<Step> steps;
...
// RES 5, (HL)
Opcode Cpu::opcode_cb_0xae_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// RES 5, A
Opcode Cpu::opcode_cb_0xaf_generator() {
    std::vector<Step> steps;
...
// RES 6, B
Opcode Cpu::opcode_cb_0xb0_generator() {
    std::vector<Step> steps;
...
// RES 6, C
Opcode Cpu::opcode_cb_0xb1_generator() {
    std::vector<Step> steps;
...
// RES 6, D
Opcode Cpu::opcode_cb_0xb2_generator() {
    std::vector<Step> steps;
...
// RES 6, E
Opcode Cpu::opcode_cb_0xb3_generator() {
    std::vector<Step> steps;
...
// RES 6, H
Opcode Cpu::opcode_cb_0xb4_generator() {
    std::vector<Step> steps;
...
// RES 6, L
Opcode Cpu::opcode_cb_0xb5_generator() {
    std::vector<Step> steps;
...
// RES 6, (HL)
Opcode Cpu::opcode_cb_0xb6_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// RES 6, A
Opcode Cpu::opcode_cb_0xb7_generator() {
    std::vector<Step> steps;
...
// RES 7, B
Opcode Cpu::opcode_cb_0xb8_generator() {
    std::vector<Step> steps;
...
// RES 7, C
Opcode Cpu::opcode_cb_0xb9_generator() {
    std::vector<Step> steps;
...
// RES 7, D
Opcode Cpu::opcode_cb_0xba_generator() {
    std::vector<Step> steps;
...
// RES 7, E
Opcode Cpu::opcode_cb_0xbb_generator() {
    std::vector<Step> steps;
...
// RES 7, H
Opcode Cpu::opcode_cb_0xbc_generator() {
    std::vector<Step> steps;
...
// RES 7, L
Opcode Cpu::opcode_cb_0xbd_generator() {
    std::vector<Step> steps;
...
// RES 7, (HL)
Opcode Cpu::opcode_cb_0xbe_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// RES 7, A
Opcode Cpu::opcode_cb_0xbf_generator() {
    std::vector<Step> steps;
...
// SET 0, B
Opcode Cpu::opcode_cb_0xc0_generator() {
    std::vector<Step> steps;
...
// SET 0, C
Opcode Cpu::opcode_cb_0xc1_generator() {
    std::vector<Step> steps;
...
// SET 0, D
Opcode Cpu::opcode_cb_0xc2_generator() {
    std::vector<Step> steps;
...
// SET 0, E
Opcode Cpu::opcode_cb_0xc3_generator() {
    std::vector<Step> steps;
...
// SET 0, H
Opcode Cpu::opcode_cb_0xc4_generator() {
    std::vector<Step> steps;
...
// SET 0, L
Opcode Cpu::opcode_cb_0xc5_generator() {
    std::vector<Step> steps;
...
// SET 0, (HL)
Opcode Cpu::opcode_cb_0xc6_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// SET 0, A
Opcode Cpu::opcode_cb_0xc7_generator() {
    std::vector<Step> steps;
...
// SET 1, B
Opcode Cpu::opcode_cb_0xc8_generator() {
    std::vector<Step> steps;
...
// SET 1, C
Opcode Cpu::opcode_cb_0xc9_generator() {
    std::vector<Step> steps;
...
// SET 1, D
Opcode Cpu::opcode_cb_0xca_generator() {
    std::vector<Step> steps;
...
// SET 1, E
Opcode Cpu::opcode_cb_0xcb_generator() {
    std::vector<Step> steps;
...
// SET 1, H
Opcode Cpu::opcode_cb_0xcc_generator() {
    std::vector<Step> steps;
...
// SET 1, L
Opcode Cpu::opcode_cb_0xcd_generator() {
    std::vector<Step> steps;
...
// SET 1, (HL)
Opcode Cpu::opcode_cb_0xce_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// SET 1, A
Opcode Cpu::opcode_cb_0xcf_generator() {
    std::vector<Step> steps;
...
// SET 2, B
Opcode Cpu::opcode_cb_0xd0_generator() {
    std::vector<Step> steps;
...
// SET 2, C
Opcode Cpu::opcode_cb_0xd1_generator() {
    std::vector<Step> steps;
...
// SET 2, D
Opcode Cpu::opcode_cb_0xd2_generator() {
    std::vector<Step> steps;
...
// SET 2, E
Opcode Cpu::opcode_cb_0xd3_generator() {
    std::vector<Step> steps;
...
// SET 2, H
Opcode Cpu::opcode_cb_0xd4_generator() {
    std::vector<Step> steps;
...
// SET 2, L
Opcode Cpu::opcode_cb_0xd5_generator() {
    std::vector<Step> steps;
...
// SET 2, (HL)
Opcode Cpu::opcode_cb_0xd6_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// SET 2, A
Opcode Cpu::opcode_cb_0xd7_generator() {
    std::vector<Step> steps;
...
// SET 3, B
Opcode Cpu::opcode_cb_0xd8_generator() {
    std::vector<Step> steps;
...
// SET 3, C
Opcode Cpu::opcode_cb_0xd9_generator() {
    std::vector<Step> steps;
...
// SET 3, D
Opcode Cpu::opcode_cb_0xda_generator() {
    std::vector<Step> steps;
...
// SET 3, E
Opcode Cpu::opcode_cb_0xdb_generator() {
    std::vector<Step> steps;
...
// SET 3, H
Opcode Cpu::opcode_cb_0xdc_generator() {
    std::vector<Step> steps;
...
// SET 3, L
Opcode Cpu::opcode_cb_0xdd_generator() {
    std::vector<Step> steps;
...
// SET 3, (HL)
Opcode Cpu::opcode_cb_0xde_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// SET 3, A
Opcode Cpu::opcode_cb_0xdf_generator() {
    std::vector<Step> steps;
...
// SET 4, B
Opcode Cpu::opcode_cb_0xe0_generator() {
    std::vector<Step> steps;
...
// SET 4, C
Opcode Cpu::opcode_cb_0xe1_generator() {
    std::vector<Step> steps;
...
// SET 4, D
Opcode Cpu::opcode_cb_0xe2_generator() {
    std::vector<Step> steps;
...
// SET 4, E
Opcode Cpu::opcode_cb_0xe3_generator() {
    std::vector<Step> steps;
...
// SET 4, H
Opcode Cpu::opcode_cb_0xe4_generator() {
    std::vector<Step> steps;
...
// SET 4, L
Opcode Cpu::opcode_cb_0xe5_generator() {
    std::vector<Step> steps;
...
// SET 4, (HL)
Opcode Cpu::opcode_cb_0xe6_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// SET 4, A
Opcode Cpu::opcode_cb_0xe7_generator() {
    std::vector<Step> steps;
...
// SET 5, B
Opcode Cpu::opcode_cb_0xe8_generator() {
    std::vector<Step> steps;
...
// SET 5, C
Opcode Cpu::opcode_cb_0xe9_generator() {
    std::vector<Step> steps;
...
// SET 5, D
Opcode Cpu::opcode_cb_0xea_generator() {
    std::vector<Step> steps;
...
// SET 5, E
Opcode Cpu::opcode_cb_0xeb_generator() {
    std::vector<Step> steps;
...
// SET 5, H
Opcode Cpu::opcode_cb_0xec_generator() {
    std::vector<Step> steps;
...
// SET 5, L
Opcode Cpu::opcode_cb_0xed_generator() {
    std::vector<Step> steps;
...
// SET 5, (HL)
Opcode Cpu::opcode_cb_0xee_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// SET 5, A
Opcode Cpu::opcode_cb_0xef_generator() {
    std::vector<Step> steps;
...
// SET 6, B
Opcode Cpu::opcode_cb_0xf0_generator() {
    std::vector<Step> steps;
...
// SET 6, C
Opcode Cpu::opcode_cb_0xf1_generator() {
    std::vector<Step> steps;
...
// SET 6, D
Opcode Cpu::opcode_cb_0xf2_generator() {
    std::vector<Step> steps;
...
// SET 6, E
Opcode Cpu::opcode_cb_0xf3_generator() {
    std::vector<Step> steps;
...
// SET 6, H
Opcode Cpu::opcode_cb_0xf4_generator() {
    std::vector<Step> steps;
...
// SET 6, L
Opcode Cpu::opcode_cb_0xf5_generator() {
    std::vector<Step> steps;
...
// SET 6, (HL)
Opcode Cpu::opcode_cb_0xf6_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// SET 6, A
Opcode Cpu::opcode_cb_0xf7_generator() {
    std::vector<Step> steps;
...
// SET 7, B
Opcode Cpu::opcode_cb_0xf8_generator() {
    std::vector<Step> steps;
...
// SET 7, C
Opcode Cpu::opcode_cb_0xf9_generator() {
    std::vector<Step> steps;
...
// SET 7, D
Opcode Cpu::opcode_cb_0xfa_generator() {
    std::vector<Step> steps;
...
// SET 7, E
Opcode Cpu::opcode_cb_0xfb_generator() {
    std::vector<Step> steps;
...
// SET 7, H
Opcode Cpu::opcode_cb_0xfc_generator() {
    std::vector<Step> steps;
...
// SET 7, L
Opcode Cpu::opcode_cb_0xfd_generator() {
    std::vector<Step> steps;
...
// SET 7, (HL)
Opcode Cpu::opcode_cb_0xfe_generator() {
    std::vector<Step> steps;
    steps.push_back([this]() { z8 = mmu->read(reg.hl()); });
...
// SET 7, A
Opcode Cpu::opcode_cb_0xff_generator() {
    std::vector<Step> steps;
